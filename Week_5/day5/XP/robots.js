...
function displayRobots(robots)
{
    ...
    {
        const html = `<div class="d-flex justify-content-center mb-5 mt-3 max-vw-20">
                <img class="m-auto rounded-circle img-fluid" src="https://picsum.photos/200/200" alt=""></div>
